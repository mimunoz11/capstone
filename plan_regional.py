...
var_precio = [
    [[-8, -8], [0, 5], [-5, 4], [-5, 0], [-4, 3], [-2, 5], [-5, 2]],
    [[-7, -7], [0, 6], [0, 3], [-1, 5], [-2, 3], [0, 5], [0, 7]],
    [[-7, -7], [-1, 4], [-5, 4], [-2, 3], [0, 4], [0, 3], [0, 3]],
    [[-7, -7], [-3, 7], [-1, 6], [-2, 2], [-4, 6], [-4, 6], [-4, 3]],
    [[-5, -5], [-2, 7], [-5, 2], [-5, 7], [-3, 7], [-3, 5], [0, 6] ],
    [[-7, -7], [-5, 2], [-3, 4], [0, 4], [-3, 0], [-3, 3], [-3, 0]],
    [[-5, -5], [-4, 2], [-3, 3], [-3, 1], [-1, 1], [-3, 3], [0, 3]],
    [[-9, -9], [-4, 5], [-3, 5], [-2, 5], [-3, 2], [-2, 3], [0, 5]],
    [[-8, -8], [-2, 6], [-1, 6], [0, 3], [-1, 5], [-3, 5], [-3, 3]],
    [[-6, -6], [-3, 4], [-2, 2], [-2, 4], [-4, 4], [-5, 4], [-3, 2]]
]
vau = 0.5
